...
class zabbix::web (
  ...
  $saml_sp_key                                                        = $zabbix::params::saml_sp_key,
  $saml_sp_cert                                                       = $zabbix::params::saml_sp_cert,
  $saml_idp_cert                                                      = $zabbix::params::saml_idp_cert,
  $saml_settings                                                      = $zabbix::params::saml_settings,
